...
これで、処理系が外界とつながり、機能を増やしていく道筋が見えました。冒頭で触れた「I/O は遅く、いつ終わるか分からない」という問題そのものは、後の並行制御の章で正面から扱います。次章からは、より「言語らしい」制御の仕組みに踏み込みます。まずは、処理の途中で異常を伝える **例外処理** を、処理系がどう実現するかを見ていきましょう。
